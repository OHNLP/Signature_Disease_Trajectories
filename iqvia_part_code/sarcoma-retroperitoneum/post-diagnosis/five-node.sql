    ...
    from (
        ...
        from (
            ...
            on
                A.ims_patient_id=B.ims_patient_id and A.4digit_icd<>B.4digit_icd 
                and DATEDIFF(B.diagnose_dt, A.diagnose_dt)>0 and DATEDIFF(B.diagnose_dt, A.diagnose_dt)<=365*3
                and A.4digit_icd='sarcoma-retroperitoneum'
            join
        ...
        and D3<>'sarcoma-retroperitoneum' and D1<>D5 and D2<>D5 and D3<>D5 and D4<>D5 and D4<>'sarcoma-retroperitoneum' and D5<>'sarcoma-retroperitoneum'
        ) as A
    group by
        D1, D2, D3, D4, D5
) as A
