...
frequent_pair as (
    ...
    where num_patient>7 and D1<>'sarcoma-retroperitoneum' and D2<>'sarcoma-retroperitoneum'
)
select * from (
select
...
from (
    ...
    from (
        ...
        from (
            ...
            on
                A.ims_patient_id=B.ims_patient_id and A.4digit_icd<>B.4digit_icd 
                and DATEDIFF(B.diagnose_dt, A.diagnose_dt)>0 and DATEDIFF(B.diagnose_dt, A.diagnose_dt)<=365*3 and A.4digit_icd<>'sarcoma-retroperitoneum' and B.4digit_icd<>'sarcoma-retroperitoneum'
            join
            ...
            on
                ...
                and C.4digit_icd<>'sarcoma-retroperitoneum'
            ) as A
        where D1<>D2 and D2<>D3 and D1<>D3 and D1<>'sarcoma-retroperitoneum' and D2<>'sarcoma-retroperitoneum'
        and D3<>'sarcoma-retroperitoneum'
        ) as A
    group by
        D1, D2, D3
) as A
