...
SOURCE_CSV="distinct_D1.csv"

# Target CSV file path
TARGET_CSV="matched_cohort_avg_comparison.csv"
...
select avg(total_3_year) as avg_pair from (
select * from (
select 
    exp_patient, isnull(total_3_year, 0) as total_3_year
from total_3_year_table) as tmp
