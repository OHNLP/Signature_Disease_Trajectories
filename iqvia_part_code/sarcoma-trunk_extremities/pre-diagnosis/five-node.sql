...
select * from (
select
    A.D1, A.D2, A.D3, A.D4, A.D5, num_patient
from (
    select
        D1, 
        D2,
    ...
    from (
        ...
        from (
            ...
            join
                cancer_patient_records as E
            on
                D.ims_patient_id=E.ims_patient_id and D.4digit_icd<>E.4digit_icd 
                and DATEDIFF(E.diagnose_dt, D.diagnose_dt)>0 and DATEDIFF(E.diagnose_dt, D.diagnose_dt)<=365*3
                and E.4digit_icd='sarcoma-trunk_extremities'
            ) as A
        where D1<>D2 and D2<>D3 and D1<>D3 and D1<>D4 and D2<>D4 and D3<>D4 and D1<>'sarcoma-trunk_extremities' and D2<>'sarcoma-trunk_extremities'
        and D3<>'sarcoma-trunk_extremities' and D1<>D5 and D2<>D5 and D3<>D5 and D4<>D5 and D4<>'sarcoma-trunk_extremities'
        and D5='sarcoma-trunk_extremities'
        ) as A
    group by
        D1, D2, D3, D4, D5
) as A
...
inner join
    frequent_pair as D
on A.D3=D.D1 and A.D4=D.D2
inner join
    frequent_pair as E
on A.D4=E.D1 and A.D5=E.D2) as A
