...
frequent_pair as (
    ...
    where num_patient>33 and D1<>'sarcoma-trunk_extremities' and D2<>'sarcoma-trunk_extremities'
)
select * from (
select
    A.D1, A.D2, A.D3, num_patient
from (
    select
        D1, 
        D2,
    ...
    from (
        ...
        from (
            ...
            on
                A.ims_patient_id=B.ims_patient_id and A.4digit_icd<>B.4digit_icd 
                and DATEDIFF(B.diagnose_dt, A.diagnose_dt)>0 and DATEDIFF(B.diagnose_dt, A.diagnose_dt)<=365*3 and A.4digit_icd<>'sarcoma-trunk_extremities' and B.4digit_icd<>'sarcoma-trunk_extremities'
            join
            ...
            on
                ...
                and C.4digit_icd<>'sarcoma-trunk_extremities'
            ) as A
        where D1<>D2 and D2<>D3 and D1<>D3 and D1<>'sarcoma-trunk_extremities' and D2<>'sarcoma-trunk_extremities'
        and D3<>'sarcoma-trunk_extremities'
        ) as A
    group by
        D1, D2, D3
) as A
...
inner join
    frequent_pair as C
on A.D2=C.D1 and A.D3=C.D2) as A
