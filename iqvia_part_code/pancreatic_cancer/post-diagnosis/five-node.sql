    ...
    from (
        ...
        from (
            ...
            on
                A.ims_patient_id=B.ims_patient_id and A.4digit_icd<>B.4digit_icd 
                and DATEDIFF(B.diagnose_dt, A.diagnose_dt)>0 and DATEDIFF(B.diagnose_dt, A.diagnose_dt)<=365*3
                and A.4digit_icd='pancreatic_cancer'
            join
        ...
        where D1<>D2 and D2<>D3 and D1<>D3 and D1<>D4 and D2<>D4 and D3<>D4 and D1='pancreatic_cancer' and D2<>'pancreatic_cancer'
        and D3<>'pancreatic_cancer' and D1<>D5 and D2<>D5 and D3<>D5 and D4<>D5 and D4<>'pancreatic_cancer' and D5<>'pancreatic_cancer'
        ) as A
    group by
        D1, D2, D3, D4, D5
) as A
