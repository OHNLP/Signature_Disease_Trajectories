...
frequent_pair as (
    ...
    where num_patient>102 and D1<>'pancreatic_cancer' and D2<>'pancreatic_cancer'
)
select * from (
select
...
from (
    ...
    from (
        ...
        from (
            ...
            on
                A.ims_patient_id=B.ims_patient_id and A.4digit_icd<>B.4digit_icd 
                and DATEDIFF(B.diagnose_dt, A.diagnose_dt)>0 and DATEDIFF(B.diagnose_dt, A.diagnose_dt)<=365*3 and A.4digit_icd<>'pancreatic_cancer' and B.4digit_icd<>'pancreatic_cancer'
            join
            ...
            on
                ...
                and C.4digit_icd<>'pancreatic_cancer'
            ) as A
        where D1<>D2 and D2<>D3 and D1<>D3 and D1<>'pancreatic_cancer' and D2<>'pancreatic_cancer' and D3<>'pancreatic_cancer'
        ) as A
    group by
        D1, D2, D3
) as A
